                ...
                <tbody>
                    <c:forEach items="${answerRecords}" var="list"  varStatus="status">
                        <tr>
                            ...
                            <td>${list.level}</td>
                            <td><a href="/ansuer/record/question?recordId=${list.id}&workName=${list.workbookName}&studentName=${requestScope.studentName}&questionCount=${list.questionCount}&correctCount=${list.correctCount}&incorrectCount=${list.incorrectCount}&level=${list.level}">review</a></td>
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
